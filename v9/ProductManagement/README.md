...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 62d012bd-9b37-492d-8f12-a2d915a10189
```

> `62d012bd-9b37-492d-8f12-a2d915a10189` is the password of the certificate, you can change it to any password you want.
