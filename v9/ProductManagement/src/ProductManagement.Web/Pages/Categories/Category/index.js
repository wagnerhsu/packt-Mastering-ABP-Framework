$(function () {
    ...
    var service = productManagement.categories.category;
                ...
                rowAction: {
                    items:
                        [
                            {
                                text: l('Edit'),
                                visible: abp.auth.isGranted('ProductManagement.Category.Update'),
                            ...
                            {
                                text: l('Delete'),
                                visible: abp.auth.isGranted('ProductManagement.Category.Delete'),
