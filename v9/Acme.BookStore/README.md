...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a8dc4679-c7b9-4dc8-9016-af69aefdb042
```

> `a8dc4679-c7b9-4dc8-9016-af69aefdb042` is the password of the certificate, you can change it to any password you want.
